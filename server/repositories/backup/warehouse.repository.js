...
class WarehouseRepository {
    ...
    static getNearByLocationCoordinates(queryString, callback) {
        ...
        // console.log("********** new console",queryString);

	const LngLat = queryString.lnglat.split(",").map(x => parseFloat(x)), //req.query.latlng.split(",");


	    //const requestDistance = parseFloat(queryString.distance) + 5;
        distance = (parseFloat(queryString.distance) + parseFloat(9)) / 3963.2; //req.query.distance
